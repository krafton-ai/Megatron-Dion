...
def _add_training_args(parser):
    ...
    group.add_argument('--optimizer', type=str, default='adam',
                       choices=['adam', 'sgd', 'dion'],
                       help='Optimizer function')
    # Dion optimizer arguments
    ...
    group.add_argument('--dion-rank-fraction', type=float, default=0.25,
                       help='Dion low-rank approximation ratio (0.0-1.0).')
    group.add_argument('--dion-rank-multiple-of', type=int, default=1,
                       help='Round Dion rank to multiple of this value.')
    ...
    group.add_argument('--dion-oversample', type=float, default=1.25,
                       help='Dion oversampling factor for RCQR.')
    group.add_argument('--dion-use-fs-collectives', action='store_true', default=True,
                       help='Enable FS collectives in Dion.')
    group.add_argument('--dion-use-compressed-comm', action='store_true', default=False,
                       help='Enable compressed communication in Dion.')
    ...
    group.add_argument('--replicate-model-parallel-size', type=int, default=1,
                       help='Replicate Parallel (RP) size for Dion 2D parallelism.')
