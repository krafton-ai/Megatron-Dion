...
class DistributedOptimizer(MixedPrecisionOptimizer):
    ...
    def __init__(
        ...
        # Check optimizer type - support Adam, HybridDeviceOptimizer, and MegatronDion
        ...
        assert isinstance(optimizer, allowed_optimizers) or optimizer is None, (
            f"Only Adam, HybridDeviceOptimizer, and MegatronDion currently supported, "
            f"due to checkpointing requirements. Got {type(optimizer)}"
        )
