...
class DistributedDion2Optimizer(DistributedMuonOptimizer):
    ...
    def _build_param_config(self, param, dist_meta, optim_group) -> Dion2ParamConfig:
        cfg = build_param_config(
            ...
            scale_mode=getattr(self.config, "dion2_scale_mode", "spectral"),
            extra_scale_factor=float(getattr(self.config, "dion2_extra_scale_factor", 0.2)),
    ...
    def _refresh_dion2_step_metadata(self, *, param, optimizer_state, optim_group, dist_meta):
        ...
        signature = (
            ...
            getattr(self.config, "dion2_scale_mode", "spectral"),
            float(getattr(self.config, "dion2_extra_scale_factor", 0.2)),
