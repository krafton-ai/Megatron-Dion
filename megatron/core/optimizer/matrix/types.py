...
class MatrixStandardGatherRoute:
    ...
    input_target_indices: Optional[torch.Tensor] = None
    input_source_indices: Optional[torch.Tensor] = None
    restore_target_indices: Optional[torch.Tensor] = None
    restore_source_indices: Optional[torch.Tensor] = None
