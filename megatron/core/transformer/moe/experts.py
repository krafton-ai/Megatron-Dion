...
class GroupedMLP(MegatronModule):
    ...
    def __init__(
        ...
        # Store num_local_experts so Dion optimizer can compute per-expert LR scaling
    ...
    def set_layer_number(self, layer_number: int):
        ...
        for local_expert_idx in range(self.num_local_experts):
            ...
            fc1_weight = self.weight1[
                :, local_expert_idx * fc1_partition_width : (local_expert_idx + 1) * fc1_partition_width
            ]
            ...
            fc2_weight = self.weight2[
                local_expert_idx * fc2_partition_height : (local_expert_idx + 1) * fc2_partition_height, :
            ]
            reinitialize_partitioned_expert_weight_(
                weight=fc2_weight,
